"""
Django settings for vtest5465raapp_1 project.
...
ROOT_URLCONF = 'vtest5465raapp_1.urls'
...
WSGI_APPLICATION = 'vtest5465raapp_1.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "vtest5465RAapp Support <support@vtest5465raapp-1.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "vtest5465raapp_1 API",
    "DESCRIPTION": "API documentation for vtest5465raapp_1 App",
    "VERSION": "v1",
}
...
if AS_BUCKET_NAME:
    ...
    DEFAULT_FILE_STORAGE = "vtest5465raapp_1.storage_backends.AzureMediaStorage"
    STATICFILES_STORAGE = "vtest5465raapp_1.storage_backends.AzureStaticStorage"
